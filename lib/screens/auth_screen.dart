...
class _AuthCardState extends State<AuthCard>
  ...
  void initState() {
    ...
    _slideAnimation=Tween(begin: Offset(0.0,-1.0),end: Offset(0.0,0.0)).animate(CurvedAnimation(parent: _controller, curve: Curves.easeIn));
    super.initState();
  }
@override
  void dispose() {
  ...
  Future<void> _submit() async {
    ...
    try {
      if (_authMode == AuthMode.Login) {
        ...
        Navigator.pushNamed(context, ProductOutlookScreen.routeName);
      } else {
        // Sign user up
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      elevation: 8.0,
      child: AnimatedBuilder(animation: heightAnimation,
